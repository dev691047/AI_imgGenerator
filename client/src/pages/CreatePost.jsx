    ...
    <section className="max-w-7xl mx-auto ">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w[500px]">
          Create imaginitive and visually stunnig images through DALL_E AI and
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64
        ...
        <div className="mt-5 flex gap-5 ">
          <button
            type="button"
            className="
            text-white bg-green-700 font-medium rounded-md text-sm
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once you have created the image you want, you can Shareit with
            others in the community
          </p>
          <button
            type="submit"
            className="mt-3 text-white bg-[#6469ff] font-medium
          font-medium rounded-md text-sm w-full sm:w-auto px-5 py-1 text-center"
          >
